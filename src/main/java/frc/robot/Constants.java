...
public class Constants {
  ...
  public static final class DriveBaseConstant {
    ...
    public static final double kFrontLeftCanCoderMagOffset = 0.122314;
    public static final double kFrontRightCanCoderMagOffset = 0.226318;
    public static final double kBackLeftCanCoderMagOffset = -0.419434;
    public static final double kBackRightCanCoderMagOffset = -0.090088;

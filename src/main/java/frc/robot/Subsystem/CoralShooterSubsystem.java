...
public class CoralShooterSubsystem extends SubsystemBase {
  ...
  public void CoralShooterOn() { // 正轉
    SetMotorVoltage(CoralShooter.kShooterMotorVoltage);
  }

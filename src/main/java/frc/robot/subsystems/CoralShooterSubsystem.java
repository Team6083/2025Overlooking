...
public class CoralShooterSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    SmartDashboard.putNumber("coralShooterLeftMotorSpeed",
        coralShooterLeftMotor.getMotorOutputVoltage());
    SmartDashboard.putNumber("coralShooterRightMotorSpeed",
        coralShooterRightMotor.getMotorOutputVoltage());
  }

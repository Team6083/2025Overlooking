...
public class SwerveToReefLeftCmd extends Command {
  ...
  public SwerveToReefLeftCmd(SwerveDrive swerveDrive, TagTrackingSubsystem tagTracking) {
    this.swerveDrive = swerveDrive;
    this.tagTracking = tagTracking;
      txController.setSetpoint(17);
      tyController.setSetpoint(4.9);

...
public class RobotContainer {
    ...
    // Elevator + Intake
    private final ParallelRaceGroup upL2Algae;
    private final ParallelRaceGroup upL3Algae;

    // Drive + Intake
    private final ParallelRaceGroup algaeOut;
    ...
    public RobotContainer() {
        ...
        // Third Test
        // Elevator + Intake
        upL2Algae = new ParallelRaceGroup(elevatorSubsystem.toGetSecAlgaeCmd(),
                algaeIntakeSubsystem.reverseIntakeCmd());
        upL3Algae = new ParallelRaceGroup(elevatorSubsystem.toGetTrdAlgaeCmd(),
                algaeIntakeSubsystem.reverseIntakeCmd());

        // Drive + Intake
        algaeOut = new ParallelRaceGroup(new RunCommand(() -> swerveDrive.drive(-0.4, 0, 0, false), swerveDrive),
                algaeIntakeSubsystem.reverseIntakeCmd()).withTimeout(1.5);
        //
